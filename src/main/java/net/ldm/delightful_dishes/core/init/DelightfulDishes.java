...
import net.ldm.delightful_dishes.item.CornItem;
import net.ldm.delightful_dishes.item.DrinkableItem;
import net.ldm.delightful_dishes.item.ShinyItem;
...
import static net.ldm.delightful_dishes.core.LDMUtils.foodItem;
import static net.ldm.delightful_dishes.core.LDMUtils.foodItemSettings;

public class DelightfulDishes implements ModInitializer {
    ...
    public static final String MOD_ID = "delightful_dishes";
    ...
    public static final SwordItem STONE_KNIFE = register(Registries.ITEM, "stone_knife", new SwordItem(ToolMaterials.STONE, 1, -2.0f, new FabricItemSettings().recipeRemainder(DelightfulDishes.STONE_KNIFE)), true);
    public static final SwordItem IRON_KNIFE = register(Registries.ITEM, "iron_knife", new SwordItem(ToolMaterials.IRON, 1, -2.0f, new FabricItemSettings().recipeRemainder(DelightfulDishes.IRON_KNIFE)), true);
    public static final SwordItem GOLDEN_KNIFE = register(Registries.ITEM, "golden_knife", new SwordItem(ToolMaterials.GOLD, 1, -2.0f, new FabricItemSettings().recipeRemainder(DelightfulDishes.GOLDEN_KNIFE)), true);
    public static final SwordItem DIAMOND_KNIFE = register(Registries.ITEM, "diamond_knife", new SwordItem(ToolMaterials.DIAMOND, 1, -2.0f, new FabricItemSettings().recipeRemainder(DelightfulDishes.DIAMOND_KNIFE)), true);
    public static final SwordItem NETHERITE_KNIFE = register(Registries.ITEM, "netherite_knife", new SwordItem(ToolMaterials.NETHERITE, 1, -2.0f, new FabricItemSettings().recipeRemainder(DelightfulDishes.NETHERITE_KNIFE)), true);
