...
public class MoFood implements ModInitializer {
    ...
    public static final Item OMELET = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(6).saturationModifier(6f).build()));
    ...
    public static final Item RAW_BACON = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(1).saturationModifier(0.2f).statusEffect(new StatusEffectInstance(StatusEffects.POISON,60*20,3), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER,15*20, 2), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA,15*20, 1), 1.0f).build()));
    public static final Item COOKED_BACON = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(2).saturationModifier(1.5f).snack().build()));
    public static final Item MUFFIN = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(6).saturationModifier(1.2f).build()));
    public static final Item GOLDEN_MUFFIN = new Item(new Item.Settings().rarity(Rarity.UNCOMMON).food(new FoodComponent.Builder().hunger(6).saturationModifier(14.4f).build()));
    public static final Item ENCHANTED_MUFFIN = new ShinyItem(new Item.Settings().rarity(Rarity.RARE).food(new FoodComponent.Builder().hunger(6).alwaysEdible().saturationModifier(9.6f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION,10*20,1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION,120*20,0), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED,15*20,1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST,15*20,1), 1.0f).build()));
    public static final Item SWEET_POTATO = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).build()));
    public static final Item BAKED_SWEET_POTATO = new Item(new Item.Settings().food(new FoodComponent.Builder().hunger(5).saturationModifier(6.0f).build()));
    ...
    public static final Item SALTY_POTATO = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(7).saturationModifier(5.8f).build()));
    ...
    public static final Item SUPER_SALTY_POTATO = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(10).saturationModifier(0.6f).build()));
    public static final Item RAW_CHICKEN_NUGGET = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER,30*20,0), 0.3f).build()));
    public static final Item COOKED_CHICKEN_NUGGET = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(2).saturationModifier(0.3f).snack().build()));
    ...
    public static final Item LETTUCE = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(1.2f).build()));
    ...
    public static final Item PIZZA_DOUGH = new Item((new Item.Settings()));
    public static final Item CHEESE = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(5).saturationModifier(6.2f).build()));
    public static final Item PIZZA_BREAD = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(8).saturationModifier(8.0f).build()));
    ...
    public static final Item RAW_CHEESE_PIZZA = new Item((new Item.Settings()));
    public static final Item RAW_PEPPERONI_PIZZA = new Item((new Item.Settings()));
    public static final Item MILK = new Item((new Item.Settings()));
    public static final Item PEPPERONI = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(1.0f).snack().build()));
    public static final Item RAW_WOLF_MEAT = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(2).saturationModifier(1.2f).build()));
    public static final Item COOKED_WOLF_MEAT = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(6).saturationModifier(9.6f).build()));
    public static final Item RAW_HORSE_MEAT = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(3).saturationModifier(1.8f).build()));
    public static final Item COOKED_HORSE_MEAT = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(8).saturationModifier(12.8f).build()));
    public static final Item RAW_CAT_STEAK = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(2).saturationModifier(1.2f).build()));
    public static final Item COOKED_CAT_STEAK = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(6).saturationModifier(9.6f).build()));
    public static final Item RAW_CALAMARI = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(2).saturationModifier(0.4f).build()));
    public static final Item COOKED_CALAMARI = new Item((new Item.Settings()).food(new FoodComponent.Builder().meat().hunger(5).saturationModifier(6f).build()));
    public static final Item OLIVES = new Item((new Item.Settings()).food(new FoodComponent.Builder().snack().hunger(1).saturationModifier(1.2f).build()));
    public static final Item LEMON = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(1.2f).build()));
    public static final Item OLIVE_OIL = new DrinkableItem((new Item.Settings()));
    public static final Item FRENCH_FRIES = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(6).saturationModifier(7.2f).build()));
    public static final Item LEMON_JUICE = new Item((new Item.Settings()));
    public static final Item BUTTER = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(4).saturationModifier(1.2f).build()));
    public static final Item RAW_BEEF_PATTY = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(3).saturationModifier(1.8f).build()));
    public static final Item COOKED_BEEF_PATTY = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(7).saturationModifier(11.4f).build()));
    public static final Item DETOXIFIED_FLESH = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.25f).build()));
    ...
    public static final Item RAW_GARLIC_BREAD = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(3).saturationModifier(4.6f).build()));
    public static final Item BAKED_GARLIC_BREAD = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(8).saturationModifier(9.6f).build()));
    public static final Item TOAST = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(2).saturationModifier(2.0f).build()));
    public static final Item GARLIC_TOAST = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(3).saturationModifier(3.2f).build()));
    public static final Item BREADSTICKS = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.5f).build()));
    public static final Item GARLIC_BREADSTICKS = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).build()));

    public static final SwordItem STONE_KNIFE = new SwordItem(ToolMaterials.STONE, 1, -2.0f, (new Item.Settings()).recipeRemainder(MoFood.STONE_KNIFE));
    public static final SwordItem IRON_KNIFE = new SwordItem(ToolMaterials.IRON, 1, -2.0f, (new Item.Settings()).recipeRemainder(MoFood.IRON_KNIFE));
    public static final SwordItem GOLDEN_KNIFE = new SwordItem(ToolMaterials.GOLD, 1, -2.0f, (new Item.Settings()).recipeRemainder(MoFood.GOLDEN_KNIFE));
    public static final SwordItem DIAMOND_KNIFE = new SwordItem(ToolMaterials.DIAMOND, 1, -2.0f, (new Item.Settings()).recipeRemainder(MoFood.DIAMOND_KNIFE));
    public static final SwordItem NETHERITE_KNIFE = new SwordItem(ToolMaterials.NETHERITE, 1, -2.0f, (new Item.Settings()).recipeRemainder(MoFood.NETHERITE_KNIFE));
    public static final Item BANANA = new Item((new Item.Settings()).food(new FoodComponent.Builder().hunger(4).saturationModifier(2.8f).build()));
    ...
    */
    ...
    public void onInitialize()
    {
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sweet_potato"), new BlockItem(SWEET_POTATOES, new Item.Settings().food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).build())));
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "salt_block"), new BlockItem(SALT_BLOCK, new Item.Settings()));
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "tomato"), new BlockItem(TOMATOES, new Item.Settings().food(new FoodComponent.Builder().hunger(1).saturationModifier(1.2f).build())));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "lettuce"), LETTUCE_CROP);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "lettuce"), new BlockItem(LETTUCE_CROP, new Item.Settings().food(new FoodComponent.Builder().hunger(1).saturationModifier(1.2f).snack().build())));
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "cheese_pizza"), new BlockItem(CHEESE_PIZZA, new Item.Settings()));
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "pepperoni_pizza"), new BlockItem(PEPPERONI_PIZZA, new Item.Settings()));
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "garlic"), new BlockItem(GARLIC_CROP, new Item.Settings().food(new FoodComponent.Builder().hunger(2).saturationModifier(0.4f).build())));
