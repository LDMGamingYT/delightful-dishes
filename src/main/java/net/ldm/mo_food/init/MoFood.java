...
public class MoFood implements ModInitializer {
    ...
    public static final Item SWEET_POTATO =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sweet_potato"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).build())));
    ...
    //public static final Block SALT_BLOCK =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "salt_block"), new Block(AbstractBlock.Settings.of(Material.AGGREGATE).strength(0.5f).sounds(BlockSoundGroup.SAND)));
    ...
    public static final Item GARLIC_TOAST =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "garlic_toast"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(3).saturationModifier(3.2f).build())));
