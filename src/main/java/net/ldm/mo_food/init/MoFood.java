...
public class MoFood implements ModInitializer {
    ...
    //public static final Block PANCAKES =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new PancakesBlock(FabricBlockSettings.of(Material.CAKE).strength(0.5F).sounds(BlockSoundGroup.WOOL)));
    public static final Item RAW_BACON =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(1).saturationModifier(0.2f).statusEffect(new StatusEffectInstance(StatusEffects.POISON,60*20,3), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER,15*20, 2), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA,15*20, 1), 1.0f).build())));
    public static final Item COOKED_BACON =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(2).saturationModifier(1.5f).snack().build())));
    public static final Item MUFFIN =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(6).saturationModifier(1.2f).build())));
    public static final Item GOLDEN_MUFFIN =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item(new FabricItemSettings().rarity(Rarity.UNCOMMON).food(new FoodComponent.Builder().hunger(6).saturationModifier(14.4f).build())));
    public static final Item ENCHANTED_MUFFIN =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new ShinyItem(new FabricItemSettings().rarity(Rarity.RARE).food(new FoodComponent.Builder().hunger(6).alwaysEdible().saturationModifier(9.6f).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION,10*20,1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION,120*20,0), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED,15*20,1), 1.0f).statusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST,15*20,1), 1.0f).build())));
    public static final Item SWEET_POTATO =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).build())));
    public static final Item BAKED_SWEET_POTATO =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(5).saturationModifier(6.0f).build())));
    //public static final Block SWEET_POTATOES =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new SweetPotatoesBlock(FabricBlockSettings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP)));
    public static final Item SALTY_POTATO =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(7).saturationModifier(5.8f).build())));
    //public static final Block SALT_BLOCK =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Block(AbstractBlock.Settings.of(Material.AGGREGATE).strength(0.5f).sounds(BlockSoundGroup.SAND)));
    ...
    public static final Item SUPER_SALTY_POTATO =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(10).saturationModifier(0.6f).build())));
    public static final Item RAW_CHICKEN_NUGGET =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.8f).statusEffect(new StatusEffectInstance(StatusEffects.HUNGER,30*20,0), 0.3f).build())));
    public static final Item COOKED_CHICKEN_NUGGET =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(2).saturationModifier(0.3f).snack().build())));
    //public static final Block TOMATOES =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new TomatoesBlock(FabricBlockSettings.of(Material.PLANT).ticksRandomly().noCollision().sounds(BlockSoundGroup.SWEET_BERRY_BUSH)));
    public static final Item LETTUCE =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(1.2f).build())));
    //public static final Block LETTUCE_CROP =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new LettuceBlock(FabricBlockSettings.of(Material.PLANT).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.CROP)));
    ...
    public static final Item CHEESE =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(5).saturationModifier(6.2f).build())));
    public static final Item PIZZA_BREAD =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(8).saturationModifier(8.0f).build())));
    //public static final Block CHEESE_PIZZA =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new CheesePizza(FabricBlockSettings.of(Material.CAKE).strength(0.5F).noCollision().sounds(BlockSoundGroup.WOOL)));
    //public static final Block PEPPERONI_PIZZA =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new PepperoniPizza(FabricBlockSettings.of(Material.CAKE).strength(0.5F).noCollision().sounds(BlockSoundGroup.WOOL)));
    ...
    public static final Item MILK = Registry.register(Registries.ITEM, new Identifier(MOD_ID, "pepperoni"), new Item(new FabricItemSettings()));
    public static final Item PEPPERONI =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(1.0f).snack().build())));
    public static final Item RAW_WOLF_MEAT =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(2).saturationModifier(1.2f).build())));
    public static final Item COOKED_WOLF_MEAT =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(6).saturationModifier(9.6f).build())));
    public static final Item RAW_HORSE_MEAT =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(3).saturationModifier(1.8f).build())));
    public static final Item COOKED_HORSE_MEAT =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(8).saturationModifier(12.8f).build())));
    public static final Item RAW_CAT_STEAK =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(2).saturationModifier(1.2f).build())));
    public static final Item COOKED_CAT_STEAK =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(6).saturationModifier(9.6f).build())));
    public static final Item RAW_CALAMARI =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(2).saturationModifier(0.4f).build())));
    public static final Item COOKED_CALAMARI =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().meat().hunger(5).saturationModifier(6f).build())));
    public static final Item OLIVES =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().snack().hunger(1).saturationModifier(1.2f).build())));
    public static final Item LEMON =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(1.2f).build())));
    ...
    public static final Item FRENCH_FRIES =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(6).saturationModifier(7.2f).build())));
    ...
    public static final Item BUTTER =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(4).saturationModifier(1.2f).build())));
    public static final Item RAW_BEEF_PATTY =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(3).saturationModifier(1.8f).build())));
    public static final Item COOKED_BEEF_PATTY =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(7).saturationModifier(11.4f).build())));
    public static final Item DETOXIFIED_FLESH =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(1).saturationModifier(0.25f).build())));
    ...
    public static final Item RAW_GARLIC_BREAD =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(3).saturationModifier(4.6f).build())));
    public static final Item BAKED_GARLIC_BREAD =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(8).saturationModifier(9.6f).build())));
    public static final Item TOAST =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(2).saturationModifier(2.0f).build())));
    ...
    public static final Item BANANA =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new Item((new FabricItemSettings()).food(new FoodComponent.Builder().hunger(4).saturationModifier(2.8f).build())));
    ...
    //public static final SwordItem DIAMOND_KNIFE =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new SwordItem(ToolMaterials.DIAMOND, 1, -2.0f, (new FabricItemSettings()).recipeRemainder(MoFood.DIAMOND_KNIFE)));
    //public static final SwordItem NETHERITE_KNIFE =  Registry.register(Registries.ITEM, new Identifier(MOD_ID, "flour"), new SwordItem(ToolMaterials.NETHERITE, 1, -2.0f, (new FabricItemSettings()).recipeRemainder(MoFood.NETHERITE_KNIFE)));
